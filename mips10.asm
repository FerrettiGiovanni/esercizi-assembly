...
# memoria e metta in $t2 il valore 1 o 2 se il numero � rispettivamente multiplo di 7 o no
...
main:	
	...
	beq $t1, 0, multiplo # Salto condizionato, se $t1 � uguale a 0, salto nella label multiplo, altrimenti eseguo la fine del programma
...
multiplo:
	li $t2, 1 # Se entro in questo label significa che ho verificato la condizione in cui il valore di $t1 � multiplo, quindi setto $t2 a 1
